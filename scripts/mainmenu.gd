...
func _process(delta):
	...
	AudioServer.set_bus_volume_db(AudioServer.get_bus_index("Music"), GameManager.music-100)
	AudioServer.set_bus_volume_db(AudioServer.get_bus_index("SFX"), GameManager.music-100)
